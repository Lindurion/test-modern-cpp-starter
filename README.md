...
- Replace all occurrences of "ToyApp" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `ToyApp` means the name of the project, while `toyapp` is used in file names.
  - Remember to rename the `include/toyapp` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
